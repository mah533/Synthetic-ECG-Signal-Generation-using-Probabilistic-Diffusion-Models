...
with open(os.path.join(myPath_dataset, "mitbih_64_adaptwin_bef75_aft75_Normalized_list.json"), "r") as f:
    data = json.load(f)
...
# data = data_64
stats_all_classes2 = Counter(np.asarray(data, dtype=object)[:, 2])
